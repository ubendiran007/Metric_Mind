 ...
 * Professional SVG icons for the InsightBridge dashboard
 * Can be easily replaced with icon libraries like Heroicons, Lucide, or Font Awesome
 */
...
export const BoltIcon = ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const Icon = ({ children, className = '' }) => (
    <span className={`nav-icon ${className}`} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
        {children}
    </span>
);
